...
export declare function setCtx(props: CreateDateRangePickerProps): {
    ...
    options: {
        ...
        weekStartsOn: import("@melt-ui/svelte/internal/helpers").WithGet<Writable<0 | 1 | 2 | 3 | 5 | 4 | 6 | undefined>>;
        ...
        readonlySegments: import("@melt-ui/svelte/internal/helpers").WithGet<Writable<{
            start: ("day" | "year" | "month" | "hour" | "minute" | "second" | "dayPeriod")[];
            end: ("day" | "year" | "month" | "hour" | "minute" | "second" | "dayPeriod")[];
        } | undefined>>;
    };
    ids: {
        rangeField: {
