...
export function getVotesforExtraSeatsTotalAllDistricts(districts: {
  [district: string]: DistrictVotes;
...
export function getVotesforExtraSeatsTotal(district: DistrictVotes): {
  [party: string]: number;
} {
...
export function getVotesforMinusSeatsTotalAllDistricts(districts: {
  [district: string]: DistrictVotes;
}): { [district: string]: { [party: string]: number } } {
  let result: { [district: string]: { [party: string]: number } } = {};
  for (let district in districts) {
...
export function getVotesforMinusSeatsTotal(district: DistrictVotes): {
  [party: string]: number;
} {
  let result: { [party: string]: number } = {};
  for (let party in district.votes) {
...
export function calculateVotesforExtraSeat(
  Votes: { votes: VoteCounts; total_seats: number },
  party: string,
): number {
...
export function calculateVotesforMinusSeat(
  Votes: { votes: VoteCounts; total_seats: number },
  party: string,
): number {
  let seatDistribution: VoteCounts = calculateSeats(Votes);
